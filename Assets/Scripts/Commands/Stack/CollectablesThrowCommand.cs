    ...
    public class CollectablesThrowCommand 
    {
        ...
        public void Execute(Transform PlayerTranform)
        {
            if (_temlList.Count>0)
            {
                ...
                _temlList[0].transform.DOJump(new Vector3(PlayerTranform.position.x+Random.Range(-1f,1f),PlayerTranform.position.y,PlayerTranform.transform.position.z+2f), 2, 1, 1.5f);
