...
namespace Managers
{
    public class SaveManager : MonoBehaviour
    {
        ...
        {
            SaveGame(SaveSignals.Instance.onGetRunnerDatas(),
        ...
        private void SaveGame(RunnerDataParams dataParams,
            IdleDataParams idleDataParams)
        {
            ...
            if (idleDataParams.AreaDatas != null)
                ES3.Save("AreaDatas",
                    idleDataParams.AreaDatas);
        ...
        private void LoadGame()
        {
            ...
            SaveSignals.Instance.onLoadRunnerData?.Invoke(new RunnerDataParams
            {
                Level = ES3.KeyExists("Level")
                    ? ES3.Load<int>("Level")
                    : 0
            });
        }
