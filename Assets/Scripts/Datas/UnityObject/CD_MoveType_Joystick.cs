...
namespace Data.UnityObject
{
    ...
    public class CD_MoveType_Joystick : Movement
    {
        ...
        public override void DoSwerveMovement(ref bool _isReadyToMove, Rigidbody _rigidbody, ref Vector2 _inputValue, ref PlayerMovementData _moveData, ref Vector2 _clampValue)
        {
